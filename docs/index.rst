.. django-primary-slug documentation master file, created by
   sphinx-quickstart on Sun Nov 14 09:50:21 2010.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

===================================
django-primary-slug's documentation
===================================
...
Welcome to the *django-primary-slug*'s documentation!
...
| **Source Code Repository**: `django-primary-slug source code <https://source.codetrax.org/hgroot/django-primary-slug>`_
| **Documentation**: `django-primary-slug documentation <http://packages.python.org/django-primary-slug>`_
| **Downloads**: `django-primary-slug releases <http://pypi.python.org/pypi/django-primary-slug>`_


About this guide
================

This guide provides an introduction to the *django-primary-slug* |version| release,
